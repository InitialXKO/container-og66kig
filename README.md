...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-og66kig.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-og66kig.containers.anotherwebservice.com/
...
```
git clone git@github.com:InitialXKO/container-og66kig.git
cd container-og66kig
```
...
```
docker attach container-og66kig
```
